							...
							<div class="product-single-details">
								...
								<div class="price-box">
									<span class="product-price">
										...
										<?php
											#== PRODUCT PRICE
											echo $GLOBALS['CURRENCY'] . " " . number_format($productResult[0]['product_price']);
										?>
						...
						foreach($relevantResult AS $eachrelevantProduct)
						{
							...
							<div class="product">
								...
								<div class="product-details">
									...
									<div class="price-box">
										<span class="product-price">'. $GLOBALS['CURRENCY'] . " " . number_format($eachrelevantProduct['product_price']) .'</span>
									</div>
